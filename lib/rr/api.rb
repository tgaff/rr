module RR
  ...
  module Adapters
    def self.const_missing(name)
      puts "Const missing: #{name.inspect}"
      if name == :RRMethods
        RR.constant_deprecated_in_favor_of('RR::Adapters::RRMethods', 'RR::API')
        RR::API
      else
        super
      end
  ...
  module Extensions
    def self.const_missing(name)
      if name == :InstanceMethods
        RR.constant_deprecated_in_favor_of('RR::Extensions::InstanceMethods', 'RR::API')
        RR::API
      else
        super
      end
